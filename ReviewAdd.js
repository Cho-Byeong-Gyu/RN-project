...
{/* 
                <TouchableOpacity style={styles.content} onPress={() => this.props.navigation.navigate('후기')} >
                    <Image style={styles.houseIMG} source={houseIMG1}></Image>
                    <View style={styles.houseInfo}>
                        <Text style={styles.houseName}> 박양순님의 거주지</Text>
                ...
                <View style={styles.reviewIMGView}>
                    <ScrollView styels={styles.reviewIMGScrollView}showsHorizontalScrollIndicator={false} horizontal={true}>
                            <Image style={styles.reviewIMG} source={houseAddIMG}/>
                    </ScrollView>
                </View>

                <View style={styles.reviewTextInpuView} >
                    <TextInput style={styles.reviewTextInput} placeholder='내용을 입력해주세요..' multiline={true}/>
                </View>
